...
- Rongquan Wang (2020). Wave loads on a land-based dual-chamber Oscillating Water Column wave energy device. *Coastal Engineering*. [doi:10.1016/j.coastaleng.2020.103744](https://doi.org/10.1016/j.coastaleng.2020.103744) [published version, CC BY-NC-ND](https://api.elsevier.com/content/article/PII:S0378383919305976?httpAccept=text/xml)
...
- Ghadirian (2021). Wave-current interaction effects on waves and their loads on a vertical cylinder. *Coastal Engineering*. [doi:10.1016/j.coastaleng.2020.103832](https://doi.org/10.1016/j.coastaleng.2020.103832) [published version, read only](https://www.sciencedirect.com/science/article/pii/S0378383920305184)
...
- Xin (2023). Coupled effects of wave and depth-dependent current interaction on loads on a bottom-fixed vertical slender cylinder. *Coastal Engineering*. [doi:10.1016/j.coastaleng.2023.104304](https://doi.org/10.1016/j.coastaleng.2023.104304) [published version, CC BY](https://api.elsevier.com/content/article/PII:S0378383923000285?httpAccept=text/xml)
- Henrik Bredmose (2021). Second-order monopile wave loads at linear cost. *Coastal Engineering*. [doi:10.1016/j.coastaleng.2021.103952](https://doi.org/10.1016/j.coastaleng.2021.103952) [submitted manuscript, read only](https://orbit.dtu.dk/en/publications/second-order-monopile-wave-loads-at-linear-cost/)
...
- Brecht Devolder (2017). Application of a buoyancy-modified k-ω SST turbulence model to simulate wave run-up around a monopile subjected to regular waves using OpenFOAM ®. *Coastal Engineering*. [doi:10.1016/j.coastaleng.2017.04.004](https://doi.org/10.1016/j.coastaleng.2017.04.004) [published version, read only](https://www.sciencedirect.com/science/article/pii/S0378383917302107)
...
- Al-Towayti (2024). Hydrodynamic Performance Assessment of Emerged, Alternatively Submerged and Submerged Semicircular Breakwater: An Experimental and Computational Study. *Journal of Marine Science and Engineering*. [doi:10.3390/jmse12071105](https://doi.org/10.3390/jmse12071105) [published version, CC BY](https://mdpi-res.com/d_attachment/jmse/jmse-12-01105/article_deploy/jmse-12-01105-v2.pdf)
