...
- Wojciechowska (2013). Practical derivation of operational dike failure probabilities. *Reliability Engineering &amp; System Safety*. [doi:10.1016/j.ress.2012.12.022](https://doi.org/10.1016/j.ress.2012.12.022)
- Gianfausto Salvadori (2016). A multivariate copula‐based framework for dealing with hazard scenarios and failure probabilities. *Water Resources Research*. [doi:10.1002/2015wr017225](https://doi.org/10.1002/2015wr017225)
- L. Wang (2022). Reliability of offshore wind turbine support structures: A state-of-the-art review. *Renewable and Sustainable Energy Reviews*. [doi:10.1016/j.rser.2022.112250](https://doi.org/10.1016/j.rser.2022.112250)
